...
function addCardInWishList(e) {
    console.log("clicked");
    e.target.src = "./images/icon-heart-02.png";
...
let img = document.querySelectorAll(".heart");
    ...
    for (let i = 0; i < img.length; i++) {
        ...
        img[i].onclick = function(e) {
            console.log(e.target.src);
            if(e.target.src=="file:///C:/Users/ACER/Desktop/CodeAcademy-Project/images/icon-heart-01.png"){
                addCardInWishList(e);

            }else{
                e.target.src="./images/icon-heart-01.png";
                var imgs=e.target.parentNode.parentNode.parentNode.parentNode.parentNode.getElementsByClassName("card-img-top");
                console.log(imgs[0]);
                var modalWL=document.getElementById("exampleModalCenter1");
                var cards=modalWL.getElementsByClassName("card");
                console.log(cards[0]);
                
                for(let j=0;j<cards.length;j++){
                   var modalImgs=cards[j].getElementsByClassName("card-img-top");
                   console.log(modalImgs[0].src);
                   console.log(imgs[0].src);
                   if(modalImgs[0].src==imgs[0].src){
                    cards[j].parentNode.outerHTML=" ";
                   }
